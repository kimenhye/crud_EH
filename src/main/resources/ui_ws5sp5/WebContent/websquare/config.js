export default {
  "WebSquare": {
    ...
    "stylesheet": {
      "@earlyImportList": "./cm/css/all.css,./cm/css/contents.css,./cm/css/print.min.css,./cm/css/atom-one-dark.min.css,./cm/js/diff2html/css/diff2html.min.css,./cm/js/codemirror/lib/codemirror.css,./cm/js/codemirror/addon/hint/show-hint.css,./cm/js/codemirror/addon/search/matchesonscrollbar.css,./cm/js/codemirror/addon/dialog/dialog.css,/cm/css/all.css,/cm/css/contents.css,/cm/css/print.min.css,/cm/css/atom-one-dark.min.css,/cm/js/diff2html/css/diff2html.min.css,/cm/js/codemirror/lib/codemirror.css,/cm/js/codemirror/addon/hint/show-hint.css,/cm/js/codemirror/addon/search/matchesonscrollbar.css,/cm/js/codemirror/addon/dialog/dialog.css",
      "@enable": "true",
      "@import": "link",
    ...
    "engine": {
      "module": [
        ...
        {
          "@src": "./cm/chartConfig/line5.js"
        },
        {
          "@src": "./cm/chartConfig/line6.js"
        },
        {
        ...
        {
          "@src": "./cm/js/codemirror/lib/codemirror.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/hint/sql-hint.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/hint/show-hint.js"
        },
        {
          "@src": "./cm/js/codemirror/mode/sql/sql.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/searchcursor.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/search.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/jump-to-line.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/match-highlighter.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/matchesonscrollbar.js"
        },
        {
          "@src": "./cm/js/codemirror/addon/search/search.js"
        },
        ...
        {
          "@src": "./cm/js/codemirror/addon/dialog/dialog.js"
        }
      ]
    },
    "ModelUtil": {
